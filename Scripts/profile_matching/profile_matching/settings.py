"""
Django settings for profile_matching project.
...
SECRET_KEY = 'django-insecure-2i^5%bp9+f%(2e^ze5qy8tnjaxgr(p%8%5bqqd2uayl-zvi_0l'
...
WSGI_APPLICATION = 'profile_matching.wsgi.application'
